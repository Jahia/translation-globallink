...
module.exports = (env, argv) => {
    let config = {
        entry: {
            main: [path.resolve(__dirname, 'src/javascript/publicPath'), path.resolve(__dirname, 'src/javascript/translations-globallink.js')]
        },
        output: {
            jsonpFunction: 'translationsGolballinkJsonp',
