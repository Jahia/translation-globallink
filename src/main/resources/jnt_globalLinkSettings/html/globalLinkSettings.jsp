...
<div class="container">
	<div class="row">
	<div class="col-md-12">
	    <form id="updateSiteForm" action="<c:url value='${url.base}${site.path}.globalLinkConfig.do'/>" method="post">
      	<div class="col-md-4">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9">
				    <input type="text" class="form-control" id="gblUsername" name="j:globalLinkUsername" value="${site.properties['j:globalLinkUsername'].string}">
				</div>
				  </fieldset>
				 ...
				 <div class="col-md-9">
				    <input type="password" class="form-control" id="gblPassword" name="j:globalLinkPassword" value="${site.properties['j:globalLinkPassword'].string}">
				 </div>
				  </fieldset>
				  ...
				  <div class="col-md-9">
				    <input type="text" class="form-control" id="gblUrl" name="j:globalLinkUrl" value="${site.properties['j:globalLinkUrl'].string}">
				  </div>
				  </fieldset>
				  ...
				  <div class="col-md-9">
				    <input type="text" class="form-control" id="gblUserAgent" name="j:globalLinkUserAgent" value="${site.properties['j:globalLinkUserAgent'].string}">
				  </div>
				  </fieldset>
				   ...
				   <div class="col-md-3">
				    ...
				    <div class="col-md-9">
				    <input type="text" class="form-control" id="gblProject" name="j:globalLinkProject" value="${site.properties['j:globalLinkProject'].string}">
				   </div>
				  </fieldset>
				 ...
				 <fieldset class="form-group">
				 <div class="col-md-3">
				    <label for="gblSubmissionPrefix"><fmt:message key="gbl.settings.submissionprefix" /></label>
				 </div>
				 <div class="col-md-9">
				    <input type="text" class="form-control" id="gblSubmissionPrefix" name="j:globalLinkSubmissionPrefix" value="${site.properties['j:globalLinkSubmissionPrefix'].string}">
				 </div>
				  </fieldset>
				  ...
				  <div class="col-md-9">
				    <input type="text" class="form-control" id="fileFormat" name="j:globalLinkfileFormat" value="${site.properties['j:globalLinkfileFormat'].string}">
				  </div>
				  </fieldset>
                  ...
                  <div class="col-md-9">
                    <input type="text" class="form-control" id="globalLinkfileLocation" name="j:globalLinkfileLocation"
                  ...
                  <fieldset class="form-group">
                    <div class="col-md-3">
                      <label for="globalLinkInterval"><fmt:message key="gbl.settings.submissioninterval" /></label>
                    </div>
                    <div class="col-md-9">
                      <input type="text" class="form-control" id="globalLinkInterval" name="j:globalLinkInterval"
	...
	<div class="col-md-5">
	    ...
	    <select name="j:componentsList" id="componentSelection" multiple>
	      <c:forEach items="${site.properties['j:componentsList']}" var="component">
              <option value="${component.string}" selected>${fn:replace(component.string, '-', ' (')})</option>
          </c:forEach>
	      <c:forEach items="${gbl:componentList(renderContext.mainResource.node, renderContext.request.locale, script, site.properties['j:componentsList'])}" var="component">
              <option value="${component.value}-${component.key}">${component.value} (${component.key})</option>
          </c:forEach>
        </select>
	</div>
    <div class="col-md-3">
