...
<%@page import="org.jahia.security.license.LicenseCheckerService" %>
<c:choose>
    <c:when test="<%= LicenseCheckerService.Stub.isAllowed("org.jahia.translationGlobalLink")%>">
                            ...
                            <c:otherwise>
                                <c:choose>
                                    <c:when test="${directions eq 'NA'}">
                                        <div style="padding:4px; font-weight:bold; background: red; color: white;"><fmt:message
                                                key="gbl.settings.configNOK"/></div>
                                    </c:when>
                                    <c:otherwise>
                                        <div style="padding:4px; font-weight:bold; background: green; color: white;"><fmt:message
                                                key="gbl.settings.configOK"/></div>
                                    </c:otherwise>
                                </c:choose>
                            </c:otherwise>
                        </c:choose>
    ...
    <c:otherwise>
        <fmt:message key="request.license.not.allowed"/>
    </c:otherwise>
</c:choose>
